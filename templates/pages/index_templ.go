...
func BodyScripts() templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_BodyScripts_7a73`,
		Function: `function __templ_BodyScripts_7a73(){console.log(
		"Hello, World!",
		"You're using Templ package to generate HTML content!",
		"Edit this JavaScript code in the ` + "`" + `./templates/pages/index.templ` + "`" + ` file.",
	);
}`,
		Call:       templ.SafeScript(`__templ_BodyScripts_7a73`),
		CallInline: templ.SafeScriptInline(`__templ_BodyScripts_7a73`),
	}
}
